...
## Features
- Core feature 1: Searching for movies using TMDB API
- Core feature 2: Add movies to your watchlist
- Core feature 3: Add the wathced movies to a watched list and give it a rating
...
1. Clone the repo
   ```bash
   git clone https://github.com/ParseDotEXE/fullstack-movie-watchlist-app.git
   ```
...
## Contact
Parsa Rahimnia - parsarahimnia@gmail.com

Project Link: https://github.com/ParseDotEXE/fullstack-movie-watchlist-app.git
